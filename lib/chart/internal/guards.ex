defmodule Chart.Internal.Guards do
  ...
  defguard is_nonnegative_numbers(x, y) when is_number(x) and is_number(y) and 0 <= x and 0 <= y
  defguard is_numbers(x, y) when is_number(x) and is_number(y)
  defguard is_positive_number(number) when is_number(number) and 0 < number
  defguard is_positive_numbers(x, y) when is_number(x) and is_number(y) and 0 < x and 0 < y
